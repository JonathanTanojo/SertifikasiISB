...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3083625105ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sertifikasi&table=book">`sertifikasi`.`book`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=datasql&table=kendaraan">`datasql`.`kendaraan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ad_semester2&table=peminjam">`ad_semester2`.`peminjam`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7159234c586a2c5e45365d7150365366">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="sertifikasi" targettable="">
...
/* Created on:     06/01/2024 07:46:07                          */
/*==============================================================*/


if exists(select 1 from sys.sysforeignkey where role=&#039;FK_LIST_BOOK_LIST_BOOK&#039;) then
    alter table LIST
       delete foreign key FK_LIST_BOOK_LIST_BOOK
end if;</span>
                        </div>
                                            <div class="message history collapsed hide"
    ...
    alter table LIST
       delete foreign key FK_LIST_BOOK_LIST_BOOK
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     06/01/2024 07:58:36                          */
/*==============================================================*/


drop table if exists BOOK;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="" targettable="">
                            <div class="action_content">
...
drop table if exists BOOK;</span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">alter table LIST add constraint FK_RELATIONSHIP_2 foreign key (U_ID)
      references USER (U_ID) on delete restrict on update restrict;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="sertifikasi" targettable="">
                            <div class="action_content">
      ...
      references USER (U_ID) on delete restrict on update restrict;</span>
                            ...
                            targetdb="sertifikasi" targettable="book">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
